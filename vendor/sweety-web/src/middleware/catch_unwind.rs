...
use sweety_http_core::util::middleware::catch_unwind::{self, CatchUnwindError};
...
/// # Examples:
/// ```rust
/// # use sweety_web::{handler::handler_service, middleware::CatchUnwind, service::ServiceExt, App, WebContext};
