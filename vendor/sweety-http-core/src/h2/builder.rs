...
{
    /// transform Self to a http2 service builder that producing a service that able to handle [sweety_io_compat::net::io_uring::TcpStream]
    pub fn io_uring(
        self,
    ) -> HttpServiceBuilder<
        marker::Http2Uring,
    ...
    E: fmt::Debug + 'static,
{
    ...
    async fn call(&self, res: Result<S, E>) -> Result<Self::Response, Self::Error> {
        ...
        Ok(H2Service::new_with_tls(self.config, service, tls_acceptor, self.is_tls))
    }
}
