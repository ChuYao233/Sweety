...
> **性能基准**：Intel J4105 四核四线程 @ 1.5GHz，2GB RAM，Debian Linux
> `bombardier -c 1000 -d 30s -k --latencies --http2` 测试 HTTPS 静态 10KB 文件，对比 Nginx 1.28.1
>
...
> | P50 | 95ms | 112ms | 相近 |
> | P90 | 315ms | **165ms** | **节省 48%** |
> | P95 | 486ms | **168ms** | **节省 65%** |
> | P99 | 1300ms | **172ms** | **节省 87%** |
> | Stdev | 153ms | **6ms** | 极其平稳 |
> | 错误数 | 19594 | **0** | 零错误 |
