...
| 项目 | Sweety | Nginx | 状态 |
|------|--------|-------|------|
| HTTP/3 内置 | ✅ | ❌ 需重编译 | Sweety 领先 |
| ACME 自动证书 | ✅ | ❌ 需 certbot | Sweety 领先 |
| Brotli 压缩 | ✅ 内置 | ❌ 第三方模块 | Sweety 领先 |
| 断路器 | ✅ 三状态机 | ⚠️ max_fails 仅计数 | Sweety 领先 |
| WebSocket H2 | ✅ | ✅ | 等价 |
| gRPC 代理 | ✅ | ✅（商业版全功能） | 基本等价 |
| 反向代理连接池 | ✅ | ✅ | 等价 |
| sendfile 大文件 | ✅ | ✅ | 等价 |
| H2 多核扩展 | ✅ SO_REUSEPORT | ✅ | 等价 |
| 配置易用性 | ✅ 预设 + 语法糖 | ❌ 纯手写 | Sweety 领先 |
| `if` / `map` 条件 | ❌ | ✅ | 待补 |
| TCP/UDP 四层代理 | ❌ | ✅ stream | 待补 |
| 内存安全 | ✅ Rust | ❌ C | Sweety 领先 |
