...
use sweety_collection::fake::{FakeSend, FakeSync};
...
/// Any `tower-http` type that impl [tower_service::Service] trait can be passed to it and used as sweety-web's service type.
...
#[cfg(test)]
mod test {
    use sweety_http_core::body::{Once, exact_body_hint};
