...
use sweety_service::{FnService, Service, fn_build};
...
/// logic of sweety-web itself. Therefore it comes with different requirement of function argument
...
#[doc(hidden)]
/// sync version of sweety_service::AsyncClosure trait.
