//! web error types.
//!
//! In sweety-web error is treated as high level type and handled lazily.
//!
//! - high level:
...
//!     // or the implicit catch all error middleware sweety-web offers. In the latter case a default
...
/// # Examples:
/// ```rust
/// # use sweety_web::error::ThreadJoinError;
...
///     // the mutex lock inside is to satisfy sweety-web's error type's thread safe guarantee: Send and Sync auto traits.
///     //
...
///     // sweety-web is able to generate minimal http response from it anyway.
/// }
/// ```
///
