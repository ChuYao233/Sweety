pub(crate) use sweety_tls::openssl::ssl::SslAcceptor as TlsAcceptor;

use core::convert::Infallible;

use sweety_io_compat::io::AsyncIo;
use sweety_service::Service;
use sweety_tls::openssl::ssl;

use crate::{http::Version, version::AsVersion};

use super::error::TlsError;

pub type TlsStream<Io> = sweety_tls::openssl::TlsStream<Io>;
...
pub type OpensslError = sweety_tls::openssl::Error;
