...
/// and expose well known concrete types `sweety-web` can handle.
///
/// # Example
/// ```rust
/// # use sweety_web::{
...
/// #   App, WebContext
/// #   };
/// // a handler function expect sweety_web::body::RequestBody as body type.
...
///
/// // an eraser middleware that transform any request body to sweety_web::body::RequestBody.
...
#[cfg(test)]
mod test {
    use sweety_http_core::body::Once;
